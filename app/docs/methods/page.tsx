  ...
  return (
    <>
      ...
      <p>
        ...
        bearings. A spread on the surface wind has nothing to vary — that field is greyed out with a
        note — and the scatter is the spread of one forecast rather than a disc over all headings, so

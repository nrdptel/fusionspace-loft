      ...
      <div className="border-t border-zinc-100 px-4 py-3 dark:border-zinc-800">
        ...
        {onEdit && (
          <p className="mt-2 text-xs text-zinc-500 dark:text-zinc-400">
            ...
            fore or aft, or (on straight-edged fins) rake the tip or resize the root by their
            corner handles. The design re-flies live, so the margin updates as you drag; arrow keys
            nudge a focused handle too.
          </p>
        )}
